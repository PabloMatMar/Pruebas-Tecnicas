...
// encrypt(/*Pasale dos parametros, el primero un string de cualquier caracter, el segundo un numero, separará los elementos indexados pares de los impares, despues concatenará los dos agrupamientos(segundos a los primeros), repetira esta operacion con el string tantas veces como n le indique*/)

//decrypt(/*Pasale dos parametros, string y numero, realizara el proceso inverso(si le pasas el resultado de lo que le pasaste a la primera funcion te devolverá el string que le pasaste(a la primera funcion)) */)